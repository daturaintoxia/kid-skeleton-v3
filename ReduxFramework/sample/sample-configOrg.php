  ...
  // 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
         'fields' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            'mute' => array('alt' => '1 Column', 'img' => ReduxFramework::$_url . 'assets/img/1col.png'),
						...
						'id'       => 'widget_opt',
						'type'     => 'switch',
						'title'    => __('Extra widget', 'redux-framework-demo'),
						'subtitle' => __('You need extra widget?', 'redux-framework-demo'),
                        ...
                        'id' => 'widget_name',
                        'type' => 'text',
                        'title' => __('Widget Name', 'redux-framework-demo'),
                        'subtitle' => __('This must be unic.', 'redux-framework-demo'),
                        ...
                        'id' => 'widget_code',
                        'type' => 'ace_editor',
                        'title' => __('Widget PHP Code', 'redux-framework-demo'),
                    ...
                    array(
						...
						'type'     => 'switch',
						'title'    => __('Extra widget', 'redux-framework-demo'),
						'subtitle' => __('Show year?', 'redux-framework-demo'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'default' => array('border-color' => '#1e73be', 'border-style' => 'solid', 'border-top' => '0px', 'border-right' => '0px', 'border-bottom' => '0px', 'border-left' => '0px')
                    ),
					array(
						'id'    => 'wrap-info',
						'type'  => 'info',
					...
					array(
                        ...
                        'type' => 'color',
						'mode' => 'background',
                        'output' => array('#navigation li a:hover'),
...
// ============================ STLIDER OPTIONS
            ...
            $this->sections[] = array(
                'icon' => 'el-icon-website',
                'title' => __('Kit slider Options', 'redux-framework-demo'),
                'fields' => array(
				...
				$fields = array(
					...
					'content'  => file_get_contents(dirname(__FILE__) . '/info-html2.html')
					),
